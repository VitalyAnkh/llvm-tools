-_- llvm/utils/emacs/README -_-

- llvm-mode - Major mode for editing LLVM IR files
  DISCLAIMER: This is an the files from the official llvm-project. I reate this to avoid clone the whole monorepo in order to use its emacs major mode.
